...
class PostgresAdapter extends adapter_1.Adapter {
    constructor(options) {
        ...
        if (options?.dateParser === date_parser_1.DateParser.STRING) {
        ...
        if (options?.numericParser === numeric_parser_1.NumericParser.NUMBER) {
        ...
        else if (options?.numericParser === numeric_parser_1.NumericParser.NUMBER_OR_STRING) {
